			...
			<div class="the-dish module">
				...
				<?php if($link = get_field('headline_main_link')) { ?><a href="<?php echo $link; ?>"><?php } ?><h2><span><?php echo esc_html(get_field('farm_main_title')); ?></span></h2>
					...
					<?php $img = get_field('full_screen_photo'); ?>
						<a href="<?php the_permalink(); ?>"><div class="full-banner" style="background-image:url(<?php echo $img['sizes']['blog-landing-size']; ?>)"></div></a>
					<div class="mobile-banner">
					<?php $imgm = get_field('mobile_photo'); ?>
							<a href="<?php the_permalink(); ?>"><img src="<?php echo $imgm['sizes']['blog-landing-size'];  ?>" alt="<?php echo $imgm['alt']; ?>" class="mobile"/></a>
					</div>
